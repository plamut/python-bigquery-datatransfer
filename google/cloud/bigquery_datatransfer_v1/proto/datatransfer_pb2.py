...
# source: google/cloud/bigquery_datatransfer_v1/proto/datatransfer.proto
...
from google.cloud.bigquery_datatransfer_v1.proto import transfer_pb2 as google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/bigquery_datatransfer_v1/proto/datatransfer.proto',
...
_DATASOURCE_AUTHORIZATIONTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='FIRST_PARTY_OAUTH', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_DATASOURCEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='deprecated', full_name='google.cloud.bigquery.datatransfer.v1.DataSourceParameter.deprecated', index=15,
...
_GETDATASOURCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A0\n.bigquerydatatransfer.googleapis.com/DataSource', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_LISTDATASOURCESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A0\022.bigquerydatatransfer.googleapis.com/DataSource', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
...
_CREATETRANSFERCONFIGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A4\0222bigquerydatatransfer.googleapis.com/TransferConfig', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='version_info', full_name='google.cloud.bigquery.datatransfer.v1.CreateTransferConfigRequest.version_info', index=3,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='service_account_name', full_name='google.cloud.bigquery.datatransfer.v1.CreateTransferConfigRequest.service_account_name', index=4,
...
_UPDATETRANSFERCONFIGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='version_info', full_name='google.cloud.bigquery.datatransfer.v1.UpdateTransferConfigRequest.version_info', index=3,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='service_account_name', full_name='google.cloud.bigquery.datatransfer.v1.UpdateTransferConfigRequest.service_account_name', index=4,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETTRANSFERCONFIGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A4\n2bigquerydatatransfer.googleapis.com/TransferConfig', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_GETTRANSFERRUNREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A)\n\'bigquerydatatransfer.googleapis.com/Run', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_LISTTRANSFERRUNSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A)\022\'bigquerydatatransfer.googleapis.com/Run', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
...
_STARTMANUALTRANSFERRUNSREQUEST_TIMERANGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='start_time', full_name='google.cloud.bigquery.datatransfer.v1.StartManualTransferRunsRequest.TimeRange.start_time', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='google.cloud.bigquery.datatransfer.v1.StartManualTransferRunsRequest.TimeRange.end_time', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STARTMANUALTRANSFERRUNSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.bigquery.datatransfer.v1.StartManualTransferRunsRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='requested_time_range', full_name='google.cloud.bigquery.datatransfer.v1.StartManualTransferRunsRequest.requested_time_range', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='requested_run_time', full_name='google.cloud.bigquery.datatransfer.v1.StartManualTransferRunsRequest.requested_run_time', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='time', full_name='google.cloud.bigquery.datatransfer.v1.StartManualTransferRunsRequest.time',
...
_STARTMANUALTRANSFERRUNSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='runs', full_name='google.cloud.bigquery.datatransfer.v1.StartManualTransferRunsResponse.runs', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATASOURCE.fields_by_name['transfer_type'].enum_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERTYPE
...
_CREATETRANSFERCONFIGREQUEST.fields_by_name['transfer_config'].message_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERCONFIG
_UPDATETRANSFERCONFIGREQUEST.fields_by_name['transfer_config'].message_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERCONFIG
_UPDATETRANSFERCONFIGREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_LISTTRANSFERCONFIGSRESPONSE.fields_by_name['transfer_configs'].message_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERCONFIG
_LISTTRANSFERRUNSREQUEST.fields_by_name['states'].enum_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERSTATE
...
_LISTTRANSFERRUNSRESPONSE.fields_by_name['transfer_runs'].message_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERRUN
_LISTTRANSFERLOGSREQUEST.fields_by_name['message_types'].enum_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERMESSAGE_MESSAGESEVERITY
_LISTTRANSFERLOGSRESPONSE.fields_by_name['transfer_messages'].message_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERMESSAGE
...
_SCHEDULETRANSFERRUNSRESPONSE.fields_by_name['runs'].message_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERRUN
_STARTMANUALTRANSFERRUNSREQUEST_TIMERANGE.fields_by_name['start_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_STARTMANUALTRANSFERRUNSREQUEST_TIMERANGE.fields_by_name['end_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_STARTMANUALTRANSFERRUNSREQUEST_TIMERANGE.containing_type = _STARTMANUALTRANSFERRUNSREQUEST
_STARTMANUALTRANSFERRUNSREQUEST.fields_by_name['requested_time_range'].message_type = _STARTMANUALTRANSFERRUNSREQUEST_TIMERANGE
_STARTMANUALTRANSFERRUNSREQUEST.fields_by_name['requested_run_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
_STARTMANUALTRANSFERRUNSREQUEST.fields_by_name['requested_time_range'].containing_oneof = _STARTMANUALTRANSFERRUNSREQUEST.oneofs_by_name['time']
_STARTMANUALTRANSFERRUNSREQUEST.oneofs_by_name['time'].fields.append(
  _STARTMANUALTRANSFERRUNSREQUEST.fields_by_name['requested_run_time'])
_STARTMANUALTRANSFERRUNSREQUEST.fields_by_name['requested_run_time'].containing_oneof = _STARTMANUALTRANSFERRUNSREQUEST.oneofs_by_name['time']
_STARTMANUALTRANSFERRUNSRESPONSE.fields_by_name['runs'].message_type = google_dot_cloud_dot_bigquery__datatransfer__v1_dot_proto_dot_transfer__pb2._TRANSFERRUN
...
DESCRIPTOR.message_types_by_name['StartManualTransferRunsRequest'] = _STARTMANUALTRANSFERRUNSREQUEST
DESCRIPTOR.message_types_by_name['StartManualTransferRunsResponse'] = _STARTMANUALTRANSFERRUNSRESPONSE
...
GetDataSourceRequest = _reflection.GeneratedProtocolMessageType('GetDataSourceRequest', (_message.Message,), {
  ...
  Attributes:
      name:
          ...
          ``projects/{project_id}/dataSources/{data_source_id}`` or ``pr
          ojects/{project_id}/locations/{location_id}/dataSources/{data_
          source_id}``
  """,
...
CreateTransferConfigRequest = _reflection.GeneratedProtocolMessageType('CreateTransferConfigRequest', (_message.Message,), {
  ...
  Attributes:
      ...
      authorization_code:
          ...
          authorization_code, please make a request to https://www.gstat
          ic.com/bigquerydatatransfer/oauthz/auth?client_id=&scope=&redi
          rect_uri=  -  client_id should be OAuth client_id of BigQuery
          DTS API for the given    data source returned by
          ListDataSources method. -  data_source_scopes are the scopes
          returned by ListDataSources method. -  redirect_uri is an
      ...
      version_info:
          ...
          users have to set the version_info claim in the token request.
          To obtain the version_info, users must use the “none+gsession”
          response type. which be return a version_info back in the
          authorization response which be be put in a JWT claim in the
          token request.
      service_account_name:
          Optional service account name. If this field is set, transfer
          config will be created with this service account credentials.
          It requires that requesting user calling this API has
...
UpdateTransferConfigRequest = _reflection.GeneratedProtocolMessageType('UpdateTransferConfigRequest', (_message.Message,), {
  ...
  Attributes:
      ...
      authorization_code:
          ...
          obtain authorization_code, please make a request to https://ww
          w.gstatic.com/bigquerydatatransfer/oauthz/auth?client_id=&scop
          e=&redirect_uri=  -  client_id should be OAuth client_id of
      ...
      service_account_name:
          ...
          “service_account_name” is set in update_mask, transfer config
          will be updated to use this service account credentials. It
          requires that requesting user calling this API has permissions
...
GetTransferConfigRequest = _reflection.GeneratedProtocolMessageType('GetTransferConfigRequest', (_message.Message,), {
  ...
  Attributes:
      name:
          Required. The field will contain name of the resource
          requested, for example:
          ``projects/{project_id}/transferConfigs/{config_id}`` or ``pro
          jects/{project_id}/locations/{location_id}/transferConfigs/{co
          nfig_id}``
  """,
...
GetTransferRunRequest = _reflection.GeneratedProtocolMessageType('GetTransferRunRequest', (_message.Message,), {
  ...
  Attributes:
      name:
          ...
          s/{config_id}/runs/{run_id}`` or ``projects/{project_id}/locat
          ions/{location_id}/transferConfigs/{config_id}/runs/{run_id}``
  """,
...
ListTransferLogsRequest = _reflection.GeneratedProtocolMessageType('ListTransferLogsRequest', (_message.Message,), {
  ...
  Attributes:
      parent:
          ...
          d}/transferConfigs/{config_id}/runs/{run_id}`` or ``projects/{
