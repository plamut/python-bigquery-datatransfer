...
# source: google/cloud/bigquery_datatransfer_v1/proto/transfer.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/bigquery_datatransfer_v1/proto/transfer.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_protobuf_dot_struct__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,])
...
TransferConfig = _reflection.GeneratedProtocolMessageType('TransferConfig', (_message.Message,), {
  ...
  Attributes:
      name:
          ...
          generated based on the config_id specified in
          CreateTransferConfigRequest along with project_id and region.
          If config_id is not provided, usually a uuid, even though it
      ...
      schedule:
          ...
          ble/python/scheduling-jobs-with-cron-yaml#the_schedule_format
